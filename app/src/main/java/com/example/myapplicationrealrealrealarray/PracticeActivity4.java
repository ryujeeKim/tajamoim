...
public class PracticeActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endButton = findViewById(R.id.imageButton9);
        ...
        endButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PracticeActivity4.this, MainActivity.class);
                startActivity(intent);
            }
        });

        // korea.txt 파일을 불러와서 줄별로 저장
        lines = loadTextFile(R.raw.bible2).split("\n");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentLineIndex < lines.length) {
                    ...
                    Intent intent = new Intent(PracticeActivity4.this, FinishActivity.class); // 버튼 비활성화 후 MainActivity3로 이동
                    startActivity(intent);
