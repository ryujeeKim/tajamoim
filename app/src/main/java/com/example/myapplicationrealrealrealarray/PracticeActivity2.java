...
public class PracticeActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endButton = findViewById(R.id.imageButton3);
        inputEditText = findViewById(R.id.inputEditText2);
        ...
        lines = loadTextFile(R.raw.short_poet1).split("\n");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentLineIndex < lines.length) {
                    ...
                    Intent intent = new Intent(PracticeActivity2.this, FinishActivity.class); // 버튼 비활성화 후 MainActivity3로 이동
                    startActivity(intent);
