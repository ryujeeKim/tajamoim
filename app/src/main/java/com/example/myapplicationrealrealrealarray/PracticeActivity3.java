...
public class PracticeActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = findViewById(R.id.imageButton8);
        endButton = findViewById(R.id.imageButton7);
        ...
        endButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PracticeActivity3.this, MainActivity.class);
                startActivity(intent);
            }
        });

        // korea.txt 파일을 불러와서 줄별로 저장
        lines = loadTextFile(R.raw.bible1).split("\n");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentLineIndex < lines.length) {
                    ...
                    Intent intent = new Intent(PracticeActivity3.this, FinishActivity.class); // 버튼 비활성화 후 MainActivity3로 이동
                    startActivity(intent);
