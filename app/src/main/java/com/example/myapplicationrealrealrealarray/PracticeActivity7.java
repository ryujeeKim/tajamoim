...
public class PracticeActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = findViewById(R.id.imageButton14);
        endButton = findViewById(R.id.imageButton13);
        inputEditText = findViewById(R.id.inputEditText7);

        // 메인 화면으로 넘어가는 '타자 연습 종료' 버튼
        endButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PracticeActivity7.this, MainActivity.class);
                startActivity(intent);
            }
        });

        // korea.txt 파일을 불러와서 줄별로 저장
        lines = loadTextFile(R.raw.gaintrott).split("\n");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentLineIndex < lines.length) {
                    ...
                    Intent intent = new Intent(PracticeActivity7.this, FinishActivity.class); // 버튼 비활성화 후 MainActivity3로 이동
                    startActivity(intent);
